...
function GrievanceForm() {
    ...
    return (
        <div className="mt-8 p-6 shadow-lg shadow-stone-400 rounded-md w-1/2 bg-slate-100">
        
        <h1 className="text-2xl mb-8 text-center font-semibold">Submit Your Grievance</h1>
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="mb-4">
                <label htmlFor="image" className="block mb-3">Upload Related Image(s) if any</label>
