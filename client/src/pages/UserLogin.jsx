...
function UserLogin() {
  ...
  function loginUser(event){
    ...
    axios.post("http://localhost:4000/studentlogin",{
      email,
      passwd
    })
  }
  ...
  return (
    ...
    <form onSubmit={loginUser} className="flex flex-col items-center justify-center gap-3 w-[60%] h-2/3 px-8 shadow-lg shadow-stone-400">
      <p className="font-semibold text-xl my-5">Student Login</p>
